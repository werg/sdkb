...
| Slow-disk dirty pages compete with GPU memory | Optional bounded archive buffers and periodic fsync/cache advice retained; fewer periodic writes, direct external checkpoints explicitly accepted for this machine. |
